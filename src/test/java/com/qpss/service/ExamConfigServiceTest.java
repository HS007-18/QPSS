...
public class ExamConfigServiceTest {
    ...
    void testValidConfigurationSave() {
        ...
        DistributionPlan result = examConfigService.saveConfiguration(com.qpss.domain.ExamType.INTERNAL_1, List.of(input));
    ...
    void testInvalidPercentageTotals() {
        ...
        IllegalArgumentException ex = assertThrows(IllegalArgumentException.class, () -> {
            examConfigService.saveConfiguration(com.qpss.domain.ExamType.INTERNAL_1, List.of(input));
        });
