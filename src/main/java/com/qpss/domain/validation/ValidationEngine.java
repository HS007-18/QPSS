package com.qpss.domain.validation;
...
public class ValidationEngine {
    ...
    public ValidationResult validate(
        ...
        DistributionPlan plan = examConfigService.getDistributionPlan(com.qpss.domain.ExamType.from(examType), com.qpss.domain.ExamFormat.from(format));
