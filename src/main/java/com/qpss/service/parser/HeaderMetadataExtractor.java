    ...
    public HeaderMetadata extract(XWPFDocument document) {
        ...
        for (XWPFTableRow row : table.getRows()) {
            ...
            if (rowText.contains("Q.No") || rowText.contains("PART - A") || rowText.contains("PART A")) {
                break; // Stop when reaching question headers
            }
            ...
            // Subject Code & Title (e.g. 24CYT302 - FUNDAMENTALS OF CYBER SECURITY)
            ...
            // Department (e.g. CSE (CYBER SECURITY))
            else if ((rowText.contains("CSE") || rowText.contains("ECE") || rowText.contains("EEE") || rowText.contains("ME") || rowText.contains("IT") || rowText.contains("CIVIL")) && !rowText.toLowerCase().contains("common to")) {
